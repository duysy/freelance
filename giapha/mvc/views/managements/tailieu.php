...
<div class="container-fluid">
    <h5 class="text-center">Chỉnh sửa tài liệu</h5>
    <form class="border" id="news_post" style=padding: 30px;" method="POST" action="<?php echo $_SERVER['URL_SERVER']; ?>/quanly/tailieu">
